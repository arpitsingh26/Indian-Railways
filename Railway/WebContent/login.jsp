...
<center><h1   style="color:orange;font-size:35px"> Login </h1></center>
<p>
<center>
  <div>
        <ul id="Menu" style="text-align:center">
<li>Loginid
<input type="text" name="loginid" size="20px"></li>
<li>Loginpass 

<input type="password" name="loginpass" size="20px"></li>
...
<center> New to Indian Railways?
<a href="/Railway/signup.jsp">Sign up</a><br><br>
