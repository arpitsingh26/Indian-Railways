...
<title>Distance Between Stations</title>
  <style type="text/css">    
...
<center><h1  style="color:orange;font-size:35px"> Distance Between Stations </h1></center>


  <div>
        <ul id="Menu" style="text-align:center">
            <li>Enter train id <input type="text" name="trainname12" size="20px"></li>
