...
<center><h1  style="color:orange;font-size:35px"> Fare Enquiry </h1></center>


  <div>
        <ul id="Menu" style="text-align:center">
            <li>Enter train id <input type="text" name="trainname1" size="20px"></li>
            <li>From station id <input type="text" name="stationname11" size="20px"></li>
            <li>To station id <input type="text" name="stationname21" size="20px"><br></li>
