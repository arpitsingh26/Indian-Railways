...
<center><h1   style="color:orange;font-size:35px"> Train Status </h1></center>
  ...
  <div>
        <ul id="Menu" style="text-align:center">
            <li>Enter train id <input type="text" name="trainname11" size="20px"></li>
            <li>Enter date <input type="text" name="date1" size="20px"></li>
            <li>Enter time <input type="text" name="time1" size="20px"></li>
